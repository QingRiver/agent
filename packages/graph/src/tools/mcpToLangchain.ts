 ...
 * 与 cli 的 `mcpToolsToToolDefs`（effect ToolDef）对应，但产出 langchain 工具供 ToolNode 调度。
 */
import type { McpTool } from '@agent/tools'
import { toolErrorMessage } from '@agent/tools'
import { DynamicStructuredTool } from '@langchain/core/tools'

/** 与 TushareMcp / HaMcp 同形的最小 MCP 客户端面 */
...
export function mcpToolsToLangchainTools(mcp: McpCallable): DynamicStructuredTool[] {
