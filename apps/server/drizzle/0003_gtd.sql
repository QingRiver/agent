...
--> statement-breakpoint
ALTER TABLE "gtd_folders" ADD CONSTRAINT "gtd_folders_parent_id_gtd_folders_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."gtd_folders"("id") ON DELETE cascade ON UPDATE no action DEFERRABLE INITIALLY DEFERRED;--> statement-breakpoint
ALTER TABLE "gtd_projects" ADD CONSTRAINT "gtd_projects_folder_id_gtd_folders_id_fk" FOREIGN KEY ("folder_id") REFERENCES "public"."gtd_folders"("id") ON DELETE set null ON UPDATE no action DEFERRABLE INITIALLY DEFERRED;--> statement-breakpoint
ALTER TABLE "gtd_tasks" ADD CONSTRAINT "gtd_tasks_project_id_gtd_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."gtd_projects"("id") ON DELETE cascade ON UPDATE no action DEFERRABLE INITIALLY DEFERRED;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_gtd_folders_parent_name" ON "gtd_folders" ("user_id", (COALESCE("parent_id", '')), "name");
